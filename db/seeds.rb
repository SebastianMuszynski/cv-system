...
We’re looking for enthusiastic, driven and innovative individuals.", logo:"http://i.forbesimg.com/media/lists/companies/ibm_416x416.jpg", deadline: Date.today + 7.months, category:"Computing", salary:13000 )
...
Job.create(title: "Research Scientist", description:"The key objective of the placement is to support in the development of Curran® a bio-derived material that is produced from agri-food by products, in particular sugarbeet (after sugar extraction). Curran® is a nano-cellulose based product which has a range of potential applications ranging from paints and coatings to composite materials. ", logo:"http://cellucomp.com/wp-content/themes/cellucomp/img/logo_footer.png", deadline: Date.today + 5.months, category:"Science", salary:14500 )
